...
Este diretório contém os resultados da análise do detector **ADWIN** (Adaptive Windowing) aplicado ao dataset de taquiarritmias ventriculares.
...
- `delta`: Threshold de confiança para detectar mudança
