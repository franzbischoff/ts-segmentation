...
Este diretório contém os resultados da análise do detector **HDDM-A** aplicado ao dataset de taquiarritmias ventriculares.

## 📊 Detector: HDDM-A

**Algoritmo**: HDDM-A (Hoeffding's Adaptive Tree Drift Detection Method - Adelson)
**Biblioteca**: scikit-multiflow
**Princípio**: Detecta mudanças de conceito monitorando estatísticas adaptativas
