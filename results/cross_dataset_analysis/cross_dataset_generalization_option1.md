...
Generated: 2026-05-12T19:59:25.565116

## Executive Summary

This analysis shows the **performance ceiling** of each detector when properly tuned per dataset, using **cross-fold F3-weighted scores** (generalization metric from 2-fold validation).

### Key Concept

- Each detector was optimized **independently** on each dataset (using 2-fold CV)
- We use the **cross-fold F3-weighted score** (performance on opposite fold) as the metric
...
## Overall Ranking (by Mean Cross-Fold F3-Weighted)

| Rank | Detector | Mean F3-weighted | Median F3-weighted | Std Dev | Min | Max | CV% | Avg Gap |
|------|----------|---------|-----------|---------|-----|-----|-----|----------|
...
**Interpretation**:
- **Mean F3-weighted**: Average performance ceiling across 3 datasets (higher = better)
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.2890**
- Median: 0.2451
- Std Dev: 0.1184
- Range: [0.1989, 0.4231]
- CV%: 41.0%
...
| Dataset | Cross-Fold F3-weighted | Intra-Fold F3-weighted | Gap |
|---------|---------------|---------------|-----|
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.4306**
- Median: 0.4790
- Std Dev: 0.1322
- Range: [0.2810, 0.5317]
- CV%: 30.7%
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.3022**
- Median: 0.3052
- Std Dev: 0.0736
- Range: [0.2271, 0.3742]
- CV%: 24.4%
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.1534**
- Median: 0.0618
- Std Dev: 0.1965
- Range: [0.0194, 0.3790]
- CV%: 128.1%
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.3203**
- Median: 0.3115
- Std Dev: 0.1082
- Range: [0.2168, 0.4326]
- CV%: 33.8%
...
**Summary Statistics**:
- Mean Cross-Fold F3-weighted: **0.3152**
- Median: 0.2775
- Std Dev: 0.0833
- Range: [0.2573, 0.4107]
- CV%: 26.4%
...
1. **Highest Average Performance**: FLOSS (mean cross-fold F3-weighted=0.4306)
...
**FLOSS**:
- ✅ **Recommended**: Excellent average performance (cross-fold F3-weighted=0.4306)
- ⚠️  Variable across datasets (CV=30.7%)
- Best use case: vtachyarrhythmias

**KSWIN**:
- ⚠️  Good option: Solid performance (cross-fold F3-weighted=0.3203)
- ⚠️  Variable across datasets (CV=33.8%)
- Best use case: afib_paroxysmal

**PAGE_HINKLEY**:
- ⚠️  Good option: Solid performance (cross-fold F3-weighted=0.3152)
- ⚠️  Variable across datasets (CV=26.4%)
- Best use case: afib_paroxysmal

**HDDM_A**:
- ⚠️  Good option: Solid performance (cross-fold F3-weighted=0.3022)
- ✅ Consistent across datasets (CV=24.4%)
- Best use case: afib_paroxysmal

**ADWIN**:
- 🔻 Consider alternatives: Lower performance (cross-fold F3-weighted=0.2890)
- ⚠️  Variable across datasets (CV=41.0%)
- Best use case: afib_paroxysmal

**HDDM_W**:
- 🔻 Consider alternatives: Lower performance (cross-fold F3-weighted=0.1534)
...
1. **Cross-Fold F3-weighted**: Performance on opposite fold from 2-fold cross-validation
