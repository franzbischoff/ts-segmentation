# Resultados do Detector FLOSS — Malignant Ventricular Arrhythmias

**Status**: ✅ COMPLETO (22 novembro 2025)

Este diretório contém os resultados da análise do detector FLOSS (Fast Lowcost Online Semantic Segmentation) aplicado ao dataset de arritmias ventriculares malignas.
...
- **22 ficheiros únicos** de ECG
- **Eventos de regime**: 592 no total
