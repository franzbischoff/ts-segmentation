...
Este diretório contém os resultados da análise do detector **KSWIN** (Kolmogorov-Smirnov Windowing) aplicado ao dataset de fibrilação atrial paroxística.

## 📊 Detector: KSWIN

**Algoritmo**: KSWIN (Kolmogorov-Smirnov Windowing)
**Biblioteca**: scikit-multiflow
**Princípio**: Detecta mudanças usando o teste estatístico de Kolmogorov-Smirnov em janelas deslizantes

**Parâmetros principais**:
- `alpha`: Nível de significância do teste KS (menor = mais conservador)
...
- **Análise cross-dataset**: [`../../cross_dataset_analysis/kswin/`](../../cross_dataset_analysis/kswin/)
