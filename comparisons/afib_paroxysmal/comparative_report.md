...
|:-------------------|:-----------------------------------|:--------------------------------------------------------|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------|
| f3_weighted        | 0.3994 (δ=0.005, ma=300, gap=1000) | 0.3885 (lambda_=1, δ=0.04, α=0.9999, ma=50, gap=1000)   | 0.4135 (α=0.005, window_size=500, stat_size=50, ma=50, gap=1000)  | 0.3588 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=True, ma=1, gap=1000)      | 0.3530 (drift_confidence=0.005, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=1000)     | 0.3109 (window_size=25, regime_threshold=0.9, regime_landmark=2, gap=200)     |
| f1_weighted        | 0.1682 (δ=0.005, ma=10, gap=1000)  | 0.1626 (lambda_=1, δ=0.001, α=0.9999, ma=50, gap=2000)  | 0.1700 (α=0.005, window_size=500, stat_size=100, ma=1, gap=2000)  | 0.1593 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=True, ma=1, gap=2000)      | 0.1771 (drift_confidence=0.001, warning_confidence=0.001, lambda_option=0.1, two_side_option=False, ma=1, gap=2000)     | 0.1934 (window_size=25, regime_threshold=0.75, regime_landmark=2.5, gap=200)  |
| nab_score_standard | -4.2820 (δ=0.05, ma=10, gap=2000)  | -5.2182 (lambda_=1, δ=0.02, α=0.9999, ma=50, gap=4000)  | -5.2573 (α=0.005, window_size=200, stat_size=20, ma=50, gap=3000) | -5.1989 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=False, ma=1, gap=3000)    | -4.4566 (drift_confidence=0.005, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=3000)    | -4.0775 (window_size=25, regime_threshold=0.75, regime_landmark=2.5, gap=200) |
| nab_score_low_fp   | -7.0183 (δ=0.005, ma=10, gap=5000) | -5.7889 (lambda_=80, δ=0.005, α=0.99, ma=200, gap=4000) | -5.6812 (α=0.001, window_size=50, stat_size=50, ma=1, gap=500)    | -6.9956 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=False, ma=100, gap=5000) | -6.0791 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=100, gap=5000) | -5.3072 (window_size=25, regime_threshold=0.65, regime_landmark=2, gap=5000)  |
| nab_score_low_fn   | -3.3841 (δ=0.08, ma=100, gap=2000) | -3.7376 (lambda_=1, δ=0.001, α=0.9999, ma=10, gap=2000) | -3.4979 (α=0.01, window_size=500, stat_size=50, ma=10, gap=2000)  | -4.3235 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=True, ma=1, gap=2000)     | -4.1400 (drift_confidence=0.005, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=2000)    | -5.8571 (window_size=25, regime_threshold=0.85, regime_landmark=2, gap=200)   |
| recall_10s         | 0.9952 (δ=0.1, ma=250, gap=500)    | 0.9995 (lambda_=1, δ=0.001, α=0.99, ma=10, gap=500)     | 1.0000 (α=0.001, window_size=100, stat_size=50, ma=100, gap=500)  | 0.9058 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=True, ma=1, gap=500)       | 0.8254 (drift_confidence=0.005, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=500)      | 0.7075 (window_size=275, regime_threshold=0.9, regime_landmark=2.5, gap=200)  |
| precision_10s      | 0.1636 (δ=0.005, ma=10, gap=3000)  | 0.1614 (lambda_=30, δ=0.005, α=0.9999, ma=10, gap=2000) | 0.1543 (α=0.01, window_size=500, stat_size=50, ma=10, gap=5000)   | 0.1628 (drift_confidence=0.0005, warning_confidence=0.001, two_side_option=True, ma=1, gap=3000)     | 0.1763 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=5000)    | 0.2350 (window_size=25, regime_threshold=0.65, regime_landmark=2, gap=5000)   |
| fp_per_min         | 2.0089 (δ=0.005, ma=10, gap=5000)  | 0.1211 (lambda_=80, δ=0.04, α=0.99, ma=200, gap=4000)   | 0.0000 (α=0.001, window_size=50, stat_size=50, ma=1, gap=500)     | 1.2292 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=False, ma=100, gap=5000)  | 0.6305 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=100, gap=5000)  | 0.2559 (window_size=25, regime_threshold=0.2, regime_landmark=4, gap=200)     |
| edd_median_s       | 1.2944 (δ=0.1, ma=250, gap=500)    | 1.2617 (lambda_=1, δ=0.005, α=0.9999, ma=10, gap=500)   | 0.9525 (α=0.05, window_size=200, stat_size=100, ma=1, gap=500)    | 2.0157 (drift_confidence=0.005, warning_confidence=0.001, two_side_option=True, ma=1, gap=500)       | 1.6686 (drift_confidence=0.005, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=1, gap=500)      | 0.0280 (window_size=150, regime_threshold=0.05, regime_landmark=5, gap=200)   |
