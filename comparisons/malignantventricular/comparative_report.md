...
|:-------------------|:-------------------------------------|:----------------------------------------------------------|:-------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------|
| f3_weighted        | 0.2641 (δ=0.1, ma=150, gap=2000)     | 0.2559 (lambda_=80, δ=0.04, α=0.9999, ma=200, gap=1000)   | 0.2699 (α=0.01, window_size=500, stat_size=20, ma=100, gap=1000)   | 0.2574 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=False, ma=100, gap=2000)   | 0.0560 (drift_confidence=0.0005, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=1, gap=1000)   | 0.2257 (window_size=25, regime_threshold=0.85, regime_landmark=3.5, gap=200)   |
| f1_weighted        | 0.0995 (δ=0.005, ma=10, gap=1000)    | 0.1002 (lambda_=80, δ=0.04, α=0.99, ma=200, gap=2000)     | 0.1010 (α=0.01, window_size=200, stat_size=30, ma=1, gap=5000)     | 0.0993 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=False, ma=100, gap=2000)   | 0.0511 (drift_confidence=0.0005, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=1, gap=1000)   | 0.1494 (window_size=25, regime_threshold=0.7, regime_landmark=3.5, gap=200)    |
| nab_score_standard | -18.9256 (δ=0.02, ma=75, gap=2000)   | -20.0441 (lambda_=10, δ=0.04, α=0.99, ma=200, gap=2000)   | -19.7894 (α=0.05, window_size=500, stat_size=30, ma=10, gap=2000)  | -20.6035 (drift_confidence=0.0005, warning_confidence=0.001, two_side_option=False, ma=100, gap=2000) | -26.9091 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=50, gap=500) | -19.3511 (window_size=25, regime_threshold=0.75, regime_landmark=2.5, gap=200) |
| nab_score_low_fp   | -29.1142 (δ=0.01, ma=25, gap=4000)   | -30.5204 (lambda_=10, δ=0.04, α=0.9999, ma=200, gap=4000) | -26.9091 (α=0.001, window_size=50, stat_size=50, ma=1, gap=500)    | -30.8173 (drift_confidence=0.0005, warning_confidence=0.001, two_side_option=False, ma=100, gap=5000) | -26.9091 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=50, gap=500) | -23.6296 (window_size=25, regime_threshold=0.7, regime_landmark=2, gap=500)    |
| nab_score_low_fn   | -21.5056 (δ=0.015, ma=150, gap=2000) | -22.1834 (lambda_=10, δ=0.04, α=0.99, ma=50, gap=2000)    | -21.4315 (α=0.001, window_size=500, stat_size=100, ma=1, gap=2000) | -21.4144 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=True, ma=50, gap=2000)   | -53.5660 (drift_confidence=0.0005, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=1, gap=2000) | -29.1474 (window_size=25, regime_threshold=0.9, regime_landmark=2, gap=200)    |
| recall_10s         | 0.9723 (δ=0.08, ma=300, gap=1000)    | 0.9896 (lambda_=30, δ=0.005, α=0.99, ma=10, gap=500)      | 0.9997 (α=0.001, window_size=50, stat_size=30, ma=100, gap=500)    | 0.9997 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=True, ma=10, gap=500)      | 0.0852 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=1, gap=500)    | 0.6375 (window_size=50, regime_threshold=0.9, regime_landmark=2, gap=200)      |
| precision_10s      | 0.1014 (δ=0.01, ma=10, gap=2000)     | 0.0984 (lambda_=80, δ=0.005, α=0.9999, ma=200, gap=4000)  | 0.0966 (α=0.01, window_size=200, stat_size=50, ma=100, gap=5000)   | 0.0897 (drift_confidence=0.0005, warning_confidence=0.001, two_side_option=False, ma=100, gap=5000)   | 0.1839 (drift_confidence=0.0005, warning_confidence=0.001, lambda_option=0.01, two_side_option=False, ma=1, gap=2000)   | 0.3182 (window_size=25, regime_threshold=0.2, regime_landmark=2, gap=200)      |
| fp_per_min         | 1.6065 (δ=0.005, ma=10, gap=5000)    | 2.7052 (lambda_=80, δ=0.04, α=0.99, ma=200, gap=4000)     | 0.0000 (α=0.001, window_size=50, stat_size=50, ma=1, gap=500)      | 2.4182 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=False, ma=100, gap=5000)   | 0.0104 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.1, two_side_option=False, ma=1, gap=2000)    | 0.0234 (window_size=25, regime_threshold=0.15, regime_landmark=2, gap=200)     |
| edd_median_s       | 2.3254 (δ=0.08, ma=300, gap=1000)    | 1.1203 (lambda_=80, δ=0.01, α=0.99, ma=10, gap=500)       | 0.8437 (α=0.001, window_size=50, stat_size=30, ma=100, gap=500)    | 1.0633 (drift_confidence=0.0001, warning_confidence=0.001, two_side_option=True, ma=50, gap=500)      | 0.0040 (drift_confidence=0.0001, warning_confidence=0.001, lambda_option=0.2, two_side_option=False, ma=100, gap=3000)  | 0.0360 (window_size=125, regime_threshold=0.1, regime_landmark=6, gap=200)     |
...
|:--------------|:----------------------|:-----------------|:----------------------|:------------------------|:----------------------|:----------------------|
| F3-Weighted   | kswin (0.2699)        | adwin (0.2641)   | hddm_a (0.2574)       | page_hinkley (0.2559)   | floss (0.2257)        | hddm_w (0.0560)       |
| NAB Standard  | adwin (-18.9256)      | floss (-19.3511) | kswin (-19.7894)      | page_hinkley (-20.0441) | hddm_a (-20.6035)     | hddm_w (-26.9091)     |
| Recall@10s    | kswin (0.9531)        | adwin (0.8974)   | page_hinkley (0.8427) | hddm_a (0.8150)         | floss (0.4749)        | hddm_w (0.0852)       |
| Precision@10s | hddm_w (0.1762)       | floss (0.0979)   | hddm_a (0.0821)       | adwin (0.0797)          | kswin (0.0632)        | page_hinkley (0.0627) |
| FP/min        | hddm_w (0.4013)       | floss (2.9805)   | hddm_a (5.6039)       | adwin (6.3429)          | page_hinkley (9.1714) | kswin (9.5130)        |
| EDD Median    | page_hinkley (2.6899) | floss (2.7724)   | kswin (2.9456)        | hddm_w (3.2237)         | adwin (4.3835)        | hddm_a (4.4714)       |
...
| F3-Weighted   | floss        |   0.2257 |        0.2172 | 20.5%                 |           25920 |
...
| F1-Weighted   | floss        |   0.1494 |        0.1394 | 0.1%                  |           25920 |
...
| NAB Standard  | floss        | -19.3511 |      -19.6574 | 40.3%                 |           25920 |
...
| NAB Low FP    | floss        | -23.6296 |      -23.8751 | 65.9%                 |           25920 |
...
| NAB Low FN    | floss        | -29.1474 |      -30.0319 | 20.4%                 |           25920 |
...
| Recall@10s    | floss        |   0.6375 |        0.6172 | 1.8%                  |           25920 |
...
| Precision@10s | floss        |   0.3182 |        0.3011 | 0.0%                  |           25920 |
...
| FP/min        | floss        |   0.0234 |        0.0238 | 1.6%                  |           25920 |
...
| EDD Median    | floss        |   0.036  |        0.036  | 2.1%                  |           22528 |
