#!/bin/bash
# Script para gerar predições do detector EDDM (Early Drift Detection Method)
# Grid search completo com parâmetros de pré-processamento

set -e

echo "========================================="
echo "EDDM Detector - Grid Search"
echo "========================================="
echo ""
echo "AVISO: O detector EDDM NÃO é apropriado para sinais contínuos de ECG streaming."
...
echo "Não recomendamos o uso de EDDM para comparativos finais em ECG."
...
OUTPUT_PATH="results/eddm/predictions_intermediate.csv"
...
echo ""
echo "Note: EDDM uses binary error conversion (z-score > 2.0)"
echo "      Designed for gradual drift detection"
...
echo "       --metrics-output results/eddm/metrics_comprehensive_with_nab.csv \\"
echo "       --report-output results/eddm/final_report_with_nab.json"
echo ""
echo "2. Generate visualizations:"
echo "   python -m src.visualize_results \\"
echo "       --metrics results/eddm/metrics_comprehensive_with_nab.csv \\"
echo "       --output-dir results/eddm/visualizations"
echo ""
echo "3. Compare with DDM:"
echo "   python -m src.compare_detectors \\"
echo "       --detectors ddm eddm \\"
echo "       --output results/comparisons/ddm_vs_eddm.md"
